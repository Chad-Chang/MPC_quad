...
extern double vx;
extern Vector2d stance_state; extern Vector2d flight_state;
void init_save_data()
{
...
void save_data(const mjModel* m, mjData* d, StateModel_* state_model)
{
    ...
    // fprintf(fid, "%f, %f, %f, %f", stance_state[0], stance_state[1], flight_state[0],flight_state[1]);
    fprintf(fid, "%f, %f", stance_state[0],stance_state[1]);
